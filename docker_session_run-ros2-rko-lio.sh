...
echo "=== rko-lio ROS2 rosbag pipeline ==="
...
ros2 launch rko_lio odometry.launch.py autodetect:=false  imu_topic:=/livox/imu  lidar_topic:=/livox/pointcloud  base_frame:=base_link  rviz:=true voxel_size:=0.3
'\'' C-m
...
echo "[record] start"
ros2 bag record /rko_lio/frame /rko_lio/odom \
